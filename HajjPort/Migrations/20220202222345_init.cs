    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PortDescription = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Port_AspNetUsers_AppUserID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortOperations", x => x.id);
                    table.ForeignKey(
                        name: "FK_PortOperations_Port_PortID",
                        column: x => x.PortID,
                        principalTable: "Port",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Port_AppUserID",
                table: "Port",
                column: "AppUserID");

            migrationBuilder.CreateIndex(
                name: "IX_PortOperations_PortID",
                table: "PortOperations",
                column: "PortID");
        }
